...
cfg = Config.fromfile('/.../mmclassification/configs/efficientnet/efficientnet-b4_8xb32_in1k.py')
...
# Enter the true class of the image (Ex: AKIEC, BCC, KL, MEL, NV)
classe_vera = 'MEL'                         
