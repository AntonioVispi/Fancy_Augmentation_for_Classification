...
```
Below is shown the example of some photos belonging to the melanoma class (MEL from ISIC), generated by the StyleGAN3, according to the procedure expressed up to this point.
