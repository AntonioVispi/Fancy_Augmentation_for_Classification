...
--network=/.../network-snapshot-000080.pkl --class=3      # If network used is the one related to training with normalized images, then
                                                          # in this example class=3 corresponds to the generation of NV images.

```
Below is shown the example of some photos belonging to the melanoma class (MEL from ISIC), generated by the StyleGAN3 trained with normalized images, according to the procedure expressed up to this point.
