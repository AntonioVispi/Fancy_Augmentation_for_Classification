...
To generate the saliency map and the inference, it is advisable to use (at `checkpoint_file`) the best network trained in this work: the one related to the Normalized Plus dataset.
