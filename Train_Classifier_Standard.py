...
cfg.runner = dict(type='EpochBasedRunner', max_epochs=100)                                   # n° epochs
cfg.lr_config = dict(policy='step', step=[30, 45, 68, 80, 90, 95], gamma=0.316227766)        # Learning rate sheduler
